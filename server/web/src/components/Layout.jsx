...
export default function Layout() {
  ...
  return (
    <div className="app">
      <nav className={`ub-navbar ${scrolled ? 'scrolled' : ''}`}>
        <div className="ub-navbar-inner">
          <Link to="/" className="ub-logo">
            <img src="/foundry-logo.png" alt="Foundry" className="ub-logo-img" />
            <span className="ub-logo-text">UNBROWSE</span>
          </Link>
          ...
          <div className="ub-nav-center">
            ...
            >
              <span className="ub-nav-indicator" />
              SKILLS
            </Link>
            <Link
              to="/docs"
        ...
        <div className="ub-navbar-border" />
      </nav>
